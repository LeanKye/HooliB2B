        ...
        {isDetailed ? (
          <Reveal delay={180}>
            <div className="mt-6">
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-2">
                <Figure caption="Первый экран" hint="Заголовок, кнопки и баннер-полоса из четырёх кадров. Одно «главное» фото сюда не ставим: фотографу нужно показать диапазон работ, а не стоковую картинку. Место кнопок не двигаем, меняем текст.">
